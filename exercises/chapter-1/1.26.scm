...
; By writing the procedure with an explicit multiplication, there are two
; explicit recursive calls for each even number, which eliminates the benefit of
; calculating exponentials by squaring; all of the operations which you
; eliminate by squaring are re-introduced by explicit multiplication.
