...
; to right. The values returned by applying the procedure to the elements are
; not used at all -- for-each is used with procedures that perform an action,
